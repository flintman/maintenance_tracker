        ...
        <div class="collapse navbar-collapse" id="mainNavbar">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                {if isset($session.user_id)}
                    <li class="nav-item"><a class="nav-link" href="units.php">{$primary_label|escape} Units</a></li>
                    <li class="nav-item"><a class="nav-link" href="units.php?secondary=0">{$secondary_label|escape} Units</a></li>
