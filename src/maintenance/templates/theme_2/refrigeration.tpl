    ...
    <div id="addEditRefrigerationForm" style="display:none;">
        <form method="post" id="addEditForm">
            ...
            <div class="card modern-card shadow-sm mb-4">
                <div class="card-header bg-gradient text-white fw-bold" style="background: linear-gradient(90deg, #232526 0%, #00bcd4 100%) !important;">Refrigeration Unit Details</div>
                <div class="card-body">
